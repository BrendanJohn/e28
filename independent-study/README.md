...
## Drawbacks of Vue.js  
Due to its relatively new prescence and light corporate backing, one drawback of Vue.js is that it operates within the context of a small community of developers. However, there are those in development world who see this as a positive factor and is evident by the simple fact that it is not uncommon for Evan to chime in on debates and conversations regarding Vue design choices.
