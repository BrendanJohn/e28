...
## Ideal use cases
Ideal use cases of React include mobile applications with React native, web development with React and Redux, and virtual reality websites and 360 experiences using React VR.  
